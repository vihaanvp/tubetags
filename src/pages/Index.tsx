  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        >
          <div className="space-y-6">
            <div>
              ...
              <Textarea
                id="video-input"
                placeholder="Enter your YouTube video title or short description..."
                value={input}
            ...
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-6 text-lg rounded-xl transition-all shadow-glow hover:shadow-glow hover:scale-[1.02]"
            >
              {isGenerating ? (
                <>
        ...
        >
          Powered by AI • Optimized for YouTube SEO
        </motion.p>
      </motion.div>
    </div>
  );
